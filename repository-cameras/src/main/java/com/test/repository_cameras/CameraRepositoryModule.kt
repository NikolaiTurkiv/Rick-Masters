...
object CameraRepositoryModule {
    ...
    @Provides
    @Singleton
    fun provideCamerasRepository(api: NetworkApi): CamerasRepository = CameraRepositoryImpl(api)

    @Provides
    @Singleton
    fun provideCamerasUseCase(camerasRepository: CamerasRepository) = CamerasUseCase(camerasRepository)
